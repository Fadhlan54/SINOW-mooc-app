        ...
        <div className="flex justify-between lg:gap-10 xl:gap-8">
          ...
          <div className="w-full lg:w-4/5">
            <div className="flex gap-3 sm:gap-6 md:gap-8">
              <button
                className={`rounded-3xl px-4 py-2 text-xs font-bold shadow-sm hover:bg-primary-01 hover:text-white min-[390px]:text-sm sm:px-8 sm:text-base md:px-12 ${filterType === "semua" ? "bg-primary-01 text-white" : "bg-white text-neutral-04"}`}
                onClick={() => setFilterType("semua")}
              >
                Semua
              </button>
              <button
                className={`rounded-3xl px-4 py-2 text-xs font-bold shadow-sm hover:bg-primary-01 hover:text-white min-[390px]:text-sm sm:px-8 sm:text-base md:px-12 ${filterType === "premium" ? "bg-primary-01 text-white" : "bg-white text-neutral-04"}`}
                onClick={() => setFilterType("premium")}
              >
                Kursus Berbayar
              </button>
              <button
                className={`rounded-3xl px-4 py-2 text-xs font-bold shadow-sm hover:bg-primary-01 hover:text-white min-[390px]:text-sm  sm:px-8 sm:text-base md:px-12 ${filterType === "gratis" ? "bg-primary-01 text-white" : "bg-white text-neutral-04"}`}
